...
function checkSelection() {
  ...
  <label for="condition">Condition:</label><select style="font-size: 21px; width: 6.9cm; margin:0cm 0cm .5cm">\
  ...
  var cloInfo ='<label for="size" >Size:</label><select style="font-size: 21px; width: 6.9cm; margin:0cm 0cm .5cm">\
  ...
  var movInfo='<label for="genre">Genre:</label><select style="font-size: 21px; width: 6.9cm; margin:0cm 0cm .5cm">\
  ...
  var gamInfo='<label for="genre">Genre:</label><select style="font-size: 21px; width: 6.9cm; margin:0cm 0cm .5cm">\
  ...
  var gamInfoR='<label for="platform">Platform:</label><select style="font-size: 21px; width: 6.9cm; margin:0cm 0cm .5cm">\
